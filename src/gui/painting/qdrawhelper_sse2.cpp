...
#endif
    const __m128i maskmask = _mm_set_epi16(0x0101_s, 0x0202_s, 0x0404_s, 0x0808_s,
                                           0x1010_s, 0x2020_s, 0x4040_s, 0x8080_s);
    const __m128i maskadd = _mm_set_epi16(0x7f7f_s, 0x7e7e_s, 0x7c7c_s, 0x7878_s,
                                          0x7070_s, 0x6060_s, 0x4040_s, 0x0000_s);
