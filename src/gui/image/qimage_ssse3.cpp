...
Q_GUI_EXPORT void QT_FASTCALL qt_convert_rgb888_to_rgb32_ssse3(quint32 *dst, const uchar *src, int len)
{
    ...
    const __m128i shuffleMask = _mm_set_epi8(0xff_c, 9, 10, 11, 0xff_c, 6, 7, 8, 0xff_c, 3, 4, 5, 0xff_c, 0, 1, 2);

    // Mask the 4 last colors of a RGB888 vector with an offset of 1 (so the last 3 bytes are RGB)
    const __m128i shuffleMaskEnd = _mm_set_epi8(0xff_c, 13, 14, 15, 0xff_c, 10, 11, 12, 0xff_c, 7, 8, 9, 0xff_c, 4, 5, 6);
