...
Q_DECLARE_METATYPE(QT_PREPEND_NAMESPACE(QMediaPlayer::State))
Q_DECLARE_METATYPE(QT_PREPEND_NAMESPACE(QMediaPlayer::MediaStatus))
Q_DECLARE_METATYPE(QT_PREPEND_NAMESPACE(QMediaPlayer::Error))
