...
{
    { "constructor", DontEnum|ReadOnly, (intptr_t)jsSVGFontFaceNameElementConstructor, (intptr_t)0 },
    { 0, 0, 0, 0 }
};
...
JSValue jsSVGFontFaceNameElementConstructor(ExecState* exec, const Identifier&, const PropertySlot& slot)
{
    JSSVGFontFaceNameElement* domObject = static_cast<JSSVGFontFaceNameElement*>(asObject(slot.slotBase()));
