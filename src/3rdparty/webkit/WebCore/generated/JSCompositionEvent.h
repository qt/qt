...
JSC::JSValue jsCompositionEventData(JSC::ExecState*, const JSC::Identifier&, const JSC::PropertySlot&);
JSC::JSValue jsCompositionEventConstructor(JSC::ExecState*, const JSC::Identifier&, const JSC::PropertySlot&);
