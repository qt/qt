...
static const HashTableValue JSSVGPathSegCurvetoQuadraticRelTableValues[6] =
{
    ...
    { "constructor", DontEnum|ReadOnly, (intptr_t)jsSVGPathSegCurvetoQuadraticRelConstructor, (intptr_t)0 },
    { 0, 0, 0, 0 }
};
...
JSValue jsSVGPathSegCurvetoQuadraticRelConstructor(ExecState* exec, const Identifier&, const PropertySlot& slot)
{
    JSSVGPathSegCurvetoQuadraticRel* domObject = static_cast<JSSVGPathSegCurvetoQuadraticRel*>(asObject(slot.slotBase()));
