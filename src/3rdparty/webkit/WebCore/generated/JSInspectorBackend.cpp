...
static const HashTableValue JSInspectorBackendPrototypeTableValues[50] =
{
    ...
    { "pauseOnExceptionsState", DontDelete|Function, (intptr_t)jsInspectorBackendPrototypeFunctionPauseOnExceptionsState, (intptr_t)0 },
    { "setPauseOnExceptionsState", DontDelete|Function, (intptr_t)jsInspectorBackendPrototypeFunctionSetPauseOnExceptionsState, (intptr_t)1 },
...
#else
    { 135, 127, JSInspectorBackendPrototypeTableValues, 0 };
#endif
...
JSValue JSC_HOST_CALL jsInspectorBackendPrototypeFunctionPauseOnExceptionsState(ExecState* exec, JSObject*, JSValue thisValue, const ArgList& args)
{
    UNUSED_PARAM(args);
    if (!thisValue.inherits(&JSInspectorBackend::s_info))
        return throwError(exec, TypeError);
    ...
    JSC::JSValue result = jsNumber(exec, imp->pauseOnExceptionsState());
    return result;
}
