...
{
    { "constructor", DontEnum|ReadOnly, (intptr_t)jsSVGFontFaceSrcElementConstructor, (intptr_t)0 },
    { 0, 0, 0, 0 }
};
...
JSValue jsSVGFontFaceSrcElementConstructor(ExecState* exec, const Identifier&, const PropertySlot& slot)
{
    JSSVGFontFaceSrcElement* domObject = static_cast<JSSVGFontFaceSrcElement*>(asObject(slot.slotBase()));
