...
JSC::JSValue jsTouchListLength(JSC::ExecState*, const JSC::Identifier&, const JSC::PropertySlot&);
JSC::JSValue jsTouchListConstructor(JSC::ExecState*, const JSC::Identifier&, const JSC::PropertySlot&);
