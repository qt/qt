...
{
    { "constructor", DontEnum|ReadOnly, (intptr_t)jsSVGAnimateColorElementConstructor, (intptr_t)0 },
    { 0, 0, 0, 0 }
};
...
JSValue jsSVGAnimateColorElementConstructor(ExecState* exec, const Identifier&, const PropertySlot& slot)
{
    JSSVGAnimateColorElement* domObject = static_cast<JSSVGAnimateColorElement*>(asObject(slot.slotBase()));
