...
JSValue jsTouchListLength(ExecState* exec, const Identifier&, const PropertySlot& slot)
{
    JSTouchList* castedThis = static_cast<JSTouchList*>(asObject(slot.slotBase()));
    UNUSED_PARAM(exec);
...
JSValue jsTouchListConstructor(ExecState* exec, const Identifier&, const PropertySlot& slot)
{
    JSTouchList* domObject = static_cast<JSTouchList*>(asObject(slot.slotBase()));
...
JSValue JSTouchList::indexGetter(ExecState* exec, const Identifier&, const PropertySlot& slot)
{
    JSTouchList* thisObj = static_cast<JSTouchList*>(asObject(slot.slotBase()));
    return toJS(exec, thisObj->globalObject(), static_cast<TouchList*>(thisObj->impl())->item(slot.index()));
}
