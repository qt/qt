...
JSC::JSValue jsPopStateEventState(JSC::ExecState*, const JSC::Identifier&, const JSC::PropertySlot&);
JSC::JSValue jsPopStateEventConstructor(JSC::ExecState*, const JSC::Identifier&, const JSC::PropertySlot&);
