...
static const HashTableValue JSSVGTRefElementTableValues[3] =
{
    ...
    { "constructor", DontEnum|ReadOnly, (intptr_t)jsSVGTRefElementConstructor, (intptr_t)0 },
    { 0, 0, 0, 0 }
};
...
JSValue jsSVGTRefElementConstructor(ExecState* exec, const Identifier&, const PropertySlot& slot)
{
    JSSVGTRefElement* domObject = static_cast<JSSVGTRefElement*>(asObject(slot.slotBase()));
