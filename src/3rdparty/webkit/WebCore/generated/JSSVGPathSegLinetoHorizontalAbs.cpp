...
static const HashTableValue JSSVGPathSegLinetoHorizontalAbsTableValues[3] =
{
    ...
    { "constructor", DontEnum|ReadOnly, (intptr_t)jsSVGPathSegLinetoHorizontalAbsConstructor, (intptr_t)0 },
    { 0, 0, 0, 0 }
};
...
JSValue jsSVGPathSegLinetoHorizontalAbsConstructor(ExecState* exec, const Identifier&, const PropertySlot& slot)
{
    JSSVGPathSegLinetoHorizontalAbs* domObject = static_cast<JSSVGPathSegLinetoHorizontalAbs*>(asObject(slot.slotBase()));
