...
static const HashTableValue JSSVGMatrixTableValues[8] =
{
    ...
    { "constructor", DontEnum|ReadOnly, (intptr_t)jsSVGMatrixConstructor, (intptr_t)0 },
    { 0, 0, 0, 0 }
};
...
JSValue jsSVGMatrixConstructor(ExecState* exec, const Identifier&, const PropertySlot& slot)
{
    JSSVGMatrix* domObject = static_cast<JSSVGMatrix*>(asObject(slot.slotBase()));
