...
JSC::JSValue jsBlobSize(JSC::ExecState*, const JSC::Identifier&, const JSC::PropertySlot&);
JSC::JSValue jsBlobConstructor(JSC::ExecState*, const JSC::Identifier&, const JSC::PropertySlot&);
