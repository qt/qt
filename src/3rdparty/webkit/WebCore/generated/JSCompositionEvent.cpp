...
{
    { "data", DontDelete|ReadOnly, (intptr_t)jsCompositionEventData, (intptr_t)0 },
    { "constructor", DontEnum|ReadOnly, (intptr_t)jsCompositionEventConstructor, (intptr_t)0 },
    { 0, 0, 0, 0 }
};
...
{
    { "initCompositionEvent", DontDelete|Function, (intptr_t)jsCompositionEventPrototypeFunctionInitCompositionEvent, (intptr_t)5 },
    { 0, 0, 0, 0 }
};
...
JSValue jsCompositionEventData(ExecState* exec, const Identifier&, const PropertySlot& slot)
{
    JSCompositionEvent* castedThis = static_cast<JSCompositionEvent*>(asObject(slot.slotBase()));
    UNUSED_PARAM(exec);
...
JSValue jsCompositionEventConstructor(ExecState* exec, const Identifier&, const PropertySlot& slot)
{
    JSCompositionEvent* domObject = static_cast<JSCompositionEvent*>(asObject(slot.slotBase()));
