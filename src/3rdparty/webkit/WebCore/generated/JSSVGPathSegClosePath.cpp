...
{
    { "constructor", DontEnum|ReadOnly, (intptr_t)jsSVGPathSegClosePathConstructor, (intptr_t)0 },
    { 0, 0, 0, 0 }
};
...
JSValue jsSVGPathSegClosePathConstructor(ExecState* exec, const Identifier&, const PropertySlot& slot)
{
    JSSVGPathSegClosePath* domObject = static_cast<JSSVGPathSegClosePath*>(asObject(slot.slotBase()));
