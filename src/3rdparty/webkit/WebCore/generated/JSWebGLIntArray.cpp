...
{
    { "get", DontDelete|Function, (intptr_t)jsWebGLIntArrayPrototypeFunctionGet, (intptr_t)1 },
    { "set", DontDelete|Function, (intptr_t)jsWebGLIntArrayPrototypeFunctionSet, (intptr_t)0 },
    { 0, 0, 0, 0 }
};
