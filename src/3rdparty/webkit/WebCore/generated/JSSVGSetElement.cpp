...
{
    { "constructor", DontEnum|ReadOnly, (intptr_t)jsSVGSetElementConstructor, (intptr_t)0 },
    { 0, 0, 0, 0 }
};
...
JSValue jsSVGSetElementConstructor(ExecState* exec, const Identifier&, const PropertySlot& slot)
{
    JSSVGSetElement* domObject = static_cast<JSSVGSetElement*>(asObject(slot.slotBase()));
