...
static const HashTableValue JSSVGAnimatedRectTableValues[4] =
{
    ...
    { "constructor", DontEnum|ReadOnly, (intptr_t)jsSVGAnimatedRectConstructor, (intptr_t)0 },
    { 0, 0, 0, 0 }
};
...
JSValue jsSVGAnimatedRectConstructor(ExecState* exec, const Identifier&, const PropertySlot& slot)
{
    JSSVGAnimatedRect* domObject = static_cast<JSSVGAnimatedRect*>(asObject(slot.slotBase()));
