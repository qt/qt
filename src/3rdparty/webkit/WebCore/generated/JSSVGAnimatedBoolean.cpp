...
static const HashTableValue JSSVGAnimatedBooleanTableValues[4] =
{
    ...
    { "constructor", DontEnum|ReadOnly, (intptr_t)jsSVGAnimatedBooleanConstructor, (intptr_t)0 },
    { 0, 0, 0, 0 }
};
...
JSValue jsSVGAnimatedBooleanConstructor(ExecState* exec, const Identifier&, const PropertySlot& slot)
{
    JSSVGAnimatedBoolean* domObject = static_cast<JSSVGAnimatedBoolean*>(asObject(slot.slotBase()));
