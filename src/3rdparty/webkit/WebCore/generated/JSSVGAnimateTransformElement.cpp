...
{
    { "constructor", DontEnum|ReadOnly, (intptr_t)jsSVGAnimateTransformElementConstructor, (intptr_t)0 },
    { 0, 0, 0, 0 }
};
...
JSValue jsSVGAnimateTransformElementConstructor(ExecState* exec, const Identifier&, const PropertySlot& slot)
{
    JSSVGAnimateTransformElement* domObject = static_cast<JSSVGAnimateTransformElement*>(asObject(slot.slotBase()));
