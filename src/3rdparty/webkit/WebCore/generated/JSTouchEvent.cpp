...
static const HashTableValue JSTouchEventTableValues[9] =
{
    ...
    { "ctrlKey", DontDelete|ReadOnly, (intptr_t)jsTouchEventCtrlKey, (intptr_t)0 },
    { "shiftKey", DontDelete|ReadOnly, (intptr_t)jsTouchEventShiftKey, (intptr_t)0 },
    { "altKey", DontDelete|ReadOnly, (intptr_t)jsTouchEventAltKey, (intptr_t)0 },
    { "metaKey", DontDelete|ReadOnly, (intptr_t)jsTouchEventMetaKey, (intptr_t)0 },
...
{
    { "initTouchEvent", DontDelete|Function, (intptr_t)jsTouchEventPrototypeFunctionInitTouchEvent, (intptr_t)13 },
    { 0, 0, 0, 0 }
};
...
JSValue jsTouchEventCtrlKey(ExecState* exec, const Identifier&, const PropertySlot& slot)
{
    JSTouchEvent* castedThis = static_cast<JSTouchEvent*>(asObject(slot.slotBase()));
    UNUSED_PARAM(exec);
    TouchEvent* imp = static_cast<TouchEvent*>(castedThis->impl());
...
JSValue jsTouchEventShiftKey(ExecState* exec, const Identifier&, const PropertySlot& slot)
{
    JSTouchEvent* castedThis = static_cast<JSTouchEvent*>(asObject(slot.slotBase()));
    UNUSED_PARAM(exec);
    TouchEvent* imp = static_cast<TouchEvent*>(castedThis->impl());
...
JSValue jsTouchEventAltKey(ExecState* exec, const Identifier&, const PropertySlot& slot)
{
    JSTouchEvent* castedThis = static_cast<JSTouchEvent*>(asObject(slot.slotBase()));
    UNUSED_PARAM(exec);
    TouchEvent* imp = static_cast<TouchEvent*>(castedThis->impl());
...
JSValue jsTouchEventMetaKey(ExecState* exec, const Identifier&, const PropertySlot& slot)
{
    JSTouchEvent* castedThis = static_cast<JSTouchEvent*>(asObject(slot.slotBase()));
    UNUSED_PARAM(exec);
    TouchEvent* imp = static_cast<TouchEvent*>(castedThis->impl());
