...
{
    { "constructor", DontEnum|ReadOnly, (intptr_t)jsSVGFEFuncGElementConstructor, (intptr_t)0 },
    { 0, 0, 0, 0 }
};
...
JSValue jsSVGFEFuncGElementConstructor(ExecState* exec, const Identifier&, const PropertySlot& slot)
{
    JSSVGFEFuncGElement* domObject = static_cast<JSSVGFEFuncGElement*>(asObject(slot.slotBase()));
