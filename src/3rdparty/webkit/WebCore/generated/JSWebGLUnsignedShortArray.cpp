...
{
    { "get", DontDelete|Function, (intptr_t)jsWebGLUnsignedShortArrayPrototypeFunctionGet, (intptr_t)1 },
    { "set", DontDelete|Function, (intptr_t)jsWebGLUnsignedShortArrayPrototypeFunctionSet, (intptr_t)0 },
    { 0, 0, 0, 0 }
};
