...
{
    { "get", DontDelete|Function, (intptr_t)jsWebGLFloatArrayPrototypeFunctionGet, (intptr_t)1 },
    { "set", DontDelete|Function, (intptr_t)jsWebGLFloatArrayPrototypeFunctionSet, (intptr_t)0 },
    { 0, 0, 0, 0 }
};
