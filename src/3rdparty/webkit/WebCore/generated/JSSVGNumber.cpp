...
static const HashTableValue JSSVGNumberTableValues[3] =
{
    ...
    { "constructor", DontEnum|ReadOnly, (intptr_t)jsSVGNumberConstructor, (intptr_t)0 },
    { 0, 0, 0, 0 }
};
...
JSValue jsSVGNumberConstructor(ExecState* exec, const Identifier&, const PropertySlot& slot)
{
    JSSVGNumber* domObject = static_cast<JSSVGNumber*>(asObject(slot.slotBase()));
