...
static const HashTableValue JSSVGAnimatedAngleTableValues[4] =
{
    ...
    { "constructor", DontEnum|ReadOnly, (intptr_t)jsSVGAnimatedAngleConstructor, (intptr_t)0 },
    { 0, 0, 0, 0 }
};
...
JSValue jsSVGAnimatedAngleConstructor(ExecState* exec, const Identifier&, const PropertySlot& slot)
{
    JSSVGAnimatedAngle* domObject = static_cast<JSSVGAnimatedAngle*>(asObject(slot.slotBase()));
