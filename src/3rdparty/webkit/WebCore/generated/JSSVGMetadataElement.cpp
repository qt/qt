...
{
    { "constructor", DontEnum|ReadOnly, (intptr_t)jsSVGMetadataElementConstructor, (intptr_t)0 },
    { 0, 0, 0, 0 }
};
...
JSValue jsSVGMetadataElementConstructor(ExecState* exec, const Identifier&, const PropertySlot& slot)
{
    JSSVGMetadataElement* domObject = static_cast<JSSVGMetadataElement*>(asObject(slot.slotBase()));
