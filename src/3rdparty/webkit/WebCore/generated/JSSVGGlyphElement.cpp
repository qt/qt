...
{
    { "constructor", DontEnum|ReadOnly, (intptr_t)jsSVGGlyphElementConstructor, (intptr_t)0 },
    { 0, 0, 0, 0 }
};
...
JSValue jsSVGGlyphElementConstructor(ExecState* exec, const Identifier&, const PropertySlot& slot)
{
    JSSVGGlyphElement* domObject = static_cast<JSSVGGlyphElement*>(asObject(slot.slotBase()));
