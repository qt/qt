...
static const HashTableValue JSSVGTextElementTableValues[5] =
{
    ...
    { "constructor", DontEnum|ReadOnly, (intptr_t)jsSVGTextElementConstructor, (intptr_t)0 },
    { 0, 0, 0, 0 }
};
...
JSValue jsSVGTextElementConstructor(ExecState* exec, const Identifier&, const PropertySlot& slot)
{
    JSSVGTextElement* domObject = static_cast<JSSVGTextElement*>(asObject(slot.slotBase()));
