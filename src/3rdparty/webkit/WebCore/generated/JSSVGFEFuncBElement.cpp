...
{
    { "constructor", DontEnum|ReadOnly, (intptr_t)jsSVGFEFuncBElementConstructor, (intptr_t)0 },
    { 0, 0, 0, 0 }
};
...
JSValue jsSVGFEFuncBElementConstructor(ExecState* exec, const Identifier&, const PropertySlot& slot)
{
    JSSVGFEFuncBElement* domObject = static_cast<JSSVGFEFuncBElement*>(asObject(slot.slotBase()));
