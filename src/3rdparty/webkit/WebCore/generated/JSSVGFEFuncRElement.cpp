...
{
    { "constructor", DontEnum|ReadOnly, (intptr_t)jsSVGFEFuncRElementConstructor, (intptr_t)0 },
    { 0, 0, 0, 0 }
};
...
JSValue jsSVGFEFuncRElementConstructor(ExecState* exec, const Identifier&, const PropertySlot& slot)
{
    JSSVGFEFuncRElement* domObject = static_cast<JSSVGFEFuncRElement*>(asObject(slot.slotBase()));
