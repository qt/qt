...
static const HashTableValue JSSVGClipPathElementTableValues[14] =
{
    ...
    { "constructor", DontEnum|ReadOnly, (intptr_t)jsSVGClipPathElementConstructor, (intptr_t)0 },
    { 0, 0, 0, 0 }
};
...
JSValue jsSVGClipPathElementConstructor(ExecState* exec, const Identifier&, const PropertySlot& slot)
{
    JSSVGClipPathElement* domObject = static_cast<JSSVGClipPathElement*>(asObject(slot.slotBase()));
