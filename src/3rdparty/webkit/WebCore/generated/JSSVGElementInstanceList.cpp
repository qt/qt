...
static const HashTableValue JSSVGElementInstanceListTableValues[3] =
{
    ...
    { "constructor", DontEnum|ReadOnly, (intptr_t)jsSVGElementInstanceListConstructor, (intptr_t)0 },
    { 0, 0, 0, 0 }
};
...
JSValue jsSVGElementInstanceListConstructor(ExecState* exec, const Identifier&, const PropertySlot& slot)
{
    JSSVGElementInstanceList* domObject = static_cast<JSSVGElementInstanceList*>(asObject(slot.slotBase()));
