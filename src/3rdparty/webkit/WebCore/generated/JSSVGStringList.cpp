...
static const HashTableValue JSSVGStringListTableValues[3] =
{
    ...
    { "constructor", DontEnum|ReadOnly, (intptr_t)jsSVGStringListConstructor, (intptr_t)0 },
    { 0, 0, 0, 0 }
};
...
JSValue jsSVGStringListConstructor(ExecState* exec, const Identifier&, const PropertySlot& slot)
{
    JSSVGStringList* domObject = static_cast<JSSVGStringList*>(asObject(slot.slotBase()));
