...
static const HashTableValue JSSVGPathSegCurvetoQuadraticSmoothAbsTableValues[4] =
{
    ...
    { "constructor", DontEnum|ReadOnly, (intptr_t)jsSVGPathSegCurvetoQuadraticSmoothAbsConstructor, (intptr_t)0 },
    { 0, 0, 0, 0 }
};
...
JSValue jsSVGPathSegCurvetoQuadraticSmoothAbsConstructor(ExecState* exec, const Identifier&, const PropertySlot& slot)
{
    JSSVGPathSegCurvetoQuadraticSmoothAbs* domObject = static_cast<JSSVGPathSegCurvetoQuadraticSmoothAbs*>(asObject(slot.slotBase()));
