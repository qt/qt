...
{
    { "constructor", DontEnum|ReadOnly, (intptr_t)jsSVGMissingGlyphElementConstructor, (intptr_t)0 },
    { 0, 0, 0, 0 }
};
...
JSValue jsSVGMissingGlyphElementConstructor(ExecState* exec, const Identifier&, const PropertySlot& slot)
{
    JSSVGMissingGlyphElement* domObject = static_cast<JSSVGMissingGlyphElement*>(asObject(slot.slotBase()));
