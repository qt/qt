...
{
    { "size", DontDelete|ReadOnly, (intptr_t)jsBlobSize, (intptr_t)0 },
    { "constructor", DontEnum|ReadOnly, (intptr_t)jsBlobConstructor, (intptr_t)0 },
    { 0, 0, 0, 0 }
};
...
JSValue jsBlobSize(ExecState* exec, const Identifier&, const PropertySlot& slot)
{
    JSBlob* castedThis = static_cast<JSBlob*>(asObject(slot.slotBase()));
    UNUSED_PARAM(exec);
...
JSValue jsBlobConstructor(ExecState* exec, const Identifier&, const PropertySlot& slot)
{
    JSBlob* domObject = static_cast<JSBlob*>(asObject(slot.slotBase()));
