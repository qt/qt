...
{
    { "constructor", DontEnum|ReadOnly, (intptr_t)jsSVGFEFuncAElementConstructor, (intptr_t)0 },
    { 0, 0, 0, 0 }
};
...
JSValue jsSVGFEFuncAElementConstructor(ExecState* exec, const Identifier&, const PropertySlot& slot)
{
    JSSVGFEFuncAElement* domObject = static_cast<JSSVGFEFuncAElement*>(asObject(slot.slotBase()));
