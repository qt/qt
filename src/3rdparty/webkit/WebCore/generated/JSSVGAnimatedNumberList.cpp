...
static const HashTableValue JSSVGAnimatedNumberListTableValues[4] =
{
    ...
    { "constructor", DontEnum|ReadOnly, (intptr_t)jsSVGAnimatedNumberListConstructor, (intptr_t)0 },
    { 0, 0, 0, 0 }
};
...
JSValue jsSVGAnimatedNumberListConstructor(ExecState* exec, const Identifier&, const PropertySlot& slot)
{
    JSSVGAnimatedNumberList* domObject = static_cast<JSSVGAnimatedNumberList*>(asObject(slot.slotBase()));
