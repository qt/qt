...
{
    { "constructor", DontEnum|ReadOnly, (intptr_t)jsSVGFontFaceElementConstructor, (intptr_t)0 },
    { 0, 0, 0, 0 }
};
...
JSValue jsSVGFontFaceElementConstructor(ExecState* exec, const Identifier&, const PropertySlot& slot)
{
    JSSVGFontFaceElement* domObject = static_cast<JSSVGFontFaceElement*>(asObject(slot.slotBase()));
