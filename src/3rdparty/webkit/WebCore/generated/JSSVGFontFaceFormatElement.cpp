...
{
    { "constructor", DontEnum|ReadOnly, (intptr_t)jsSVGFontFaceFormatElementConstructor, (intptr_t)0 },
    { 0, 0, 0, 0 }
};
...
JSValue jsSVGFontFaceFormatElementConstructor(ExecState* exec, const Identifier&, const PropertySlot& slot)
{
    JSSVGFontFaceFormatElement* domObject = static_cast<JSSVGFontFaceFormatElement*>(asObject(slot.slotBase()));
