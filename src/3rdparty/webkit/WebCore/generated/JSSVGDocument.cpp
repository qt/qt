...
static const HashTableValue JSSVGDocumentTableValues[3] =
{
    ...
    { "constructor", DontEnum|ReadOnly, (intptr_t)jsSVGDocumentConstructor, (intptr_t)0 },
    { 0, 0, 0, 0 }
};
...
JSValue jsSVGDocumentConstructor(ExecState* exec, const Identifier&, const PropertySlot& slot)
{
    JSSVGDocument* domObject = static_cast<JSSVGDocument*>(asObject(slot.slotBase()));
