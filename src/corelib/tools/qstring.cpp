    ...
    */
    while (index != -1) {
        ...
        while (i < pos) {
            ...
            memcpy(static_cast<void *>(uc), static_cast<const void *>(d->data + copystart),
                   size * sizeof(QChar));
            uc += size;
            memcpy(static_cast<void *>(uc), static_cast<const void *>(after.d->data),
                   al * sizeof(QChar));
            uc += al;
